...
public class CriticismEmployeeContentPanel extends javax.swing.JFrame implements ActionListener, ListSelectionListener, MouseListener {
   ...
   public void tableInit() {
        Object[] newRowData = {1,"Nguyễn Như Phương", "LKL001","100,000", "02/01/2024"};
    ...
    private void initComponents() {
        ...
        if (CriticismEmployeeTable.getColumnModel().getColumnCount() > 0) {
            ...
            CriticismEmployeeTable.getColumnModel().getColumn(4).setPreferredWidth(3);
        }
