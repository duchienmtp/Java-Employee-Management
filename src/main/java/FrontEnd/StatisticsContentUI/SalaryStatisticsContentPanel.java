...
public class SalaryStatisticsContentPanel extends javax.swing.JPanel {
    ...
    public void formInit() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (label != null) {
                label.setText((i + 1) + ") " + employeeName + ": " + numberFormat.format(salary) + " VNĐ");
            }
        }
    }
    ...
    private JFreeChart createChart(CategoryDataset categoryDataset) {
        ...
        JFreeChart barChart = ChartFactory.createBarChart(
                ...
                time, "Số Tiền (VNĐ)",
                createDataset(Redux.statisticsBUS.getTop5HighestSalaryEmployees()), PlotOrientation.VERTICAL, false,
                false, false);
        return barChart;
    }
